    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{#delete_qa#|ucfirst}</h4>
            </div>
            <form id="del_qa_page" class="forms_plugins_cat_rel" method="post" action="{$pluginUrl}&amp;getlang={$smarty.get.getlang}&amp;tab=account&amp;action=delete">
