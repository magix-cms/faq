...
{block name='article'}
    ...
    {block name='article:content'}
        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            {foreach $faq as $QA}
                <div class="card panel panel-default" itemprop="hasPart" itemscope itemtype="http://schema.org/Question">
                    <div class="card-header panel-heading" role="tab" id="heading{$QA@index +1}">
                    ...
                    <div id="collapse{$QA@index +1}" class="panel-collapse collapse {if $QA@first}in{/if}" role="tabpanel" aria-labelledby="heading{$QA@index +1}">
                        <div class="card-block panel-body" itemprop="acceptedAnswer" itemscope itemtype="http://schema.org/Answer">
